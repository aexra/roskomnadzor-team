...
def analyze_metrics(metrics):
    ...
    try:    
        ...
        warning(f"{limits['Max processes']['soft']} Проблема: Процесс не имеет лимита. Рекомендации: Установите лимиты в /etc/security/limits.conf (например, * soft nproc 65535). Примените: ulimit -u 65535 или prlimit --pid <pid> --nofile=65535:65535. Проверьте: cat /proc/<pid>/limits.")
